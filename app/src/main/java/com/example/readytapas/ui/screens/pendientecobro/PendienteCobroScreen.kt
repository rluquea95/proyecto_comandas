...
fun PendienteCobroScreen(
    ...
    GenerarPdfTicketHandler(
        pedidosFlow = viewModel.cobradoEvent,
        getLineas = viewModel::getLineasAgrupadasPorMesa
    )
    ...
    PendienteCobroContent(
        ...
        getLineasAgrupadas = viewModel::getLineasAgrupadasPorMesa
    )
}
                        ...
                        Column(modifier = Modifier.padding(16.dp)) {
                            ...
                            if (isExpanded) {
                                ...
                                Button(
                                    ...
                                    Text("Cerrar Pedido", fontSize = 16.sp)
                                }
                            }
                        }
                }
...
fun PendienteCobroContentPreview() {
    ...
    // Función simulada para agrupar líneas del pedido
